	...
	<body>
		...
		<div class="d-flex align-items-start">
		  ...
		  <div class="nav flex-column nav-pills me-3 col-2 fs-4 text-left"  id="v-pills-tab" role="tablist" aria-orientation="vertical">
		    ...
		    <a class="nav-link btn-primary" href="/documentos" style="background-color: black; margin: 5px 0px 5px 0px"><i class="far fa-file-pdf" style="color: blue"></i> &nbsp Documentos</a>
		  </div>
