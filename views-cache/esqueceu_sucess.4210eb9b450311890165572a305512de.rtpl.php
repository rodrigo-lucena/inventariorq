...
<head>
	...
	<meta charset="UTF-8"/>	<title>InventárioRQ</title>
</head>
<body id="teste">
	<div id="head">
	...
	<div id="main" style="height: 200px">
		<h3 style="text-align: center">Senha modificada com sucesso!</h3>
		<p>Entre com o seu nome de usuário e nova senha para acessar o InventárioRQ.</p>
