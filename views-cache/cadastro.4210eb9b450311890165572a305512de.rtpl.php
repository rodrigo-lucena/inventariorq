	...
	<div id="form" style="height: auto">
		...
		<form class="row g-3 fs-3 needs-validation" action="/cadastro" method="post">
		  ...
		  <div class="col-md-4">
		    ...
		    <input type="password" class="form-control fs-3" minlength="6" maxlength="15" id="senha" name="senha" placeholder="6 a 15 caracteres" required>
		  </div>
		  <div class="col-md-4">
		    <label for="csenha" class="form-label">Confirmação de senha</label>
		    <input type="password" minlength="6" maxlength="15" class="form-control fs-3" maxlength="10" id="csenha" placeholder="6 a 15 caracteres" required>
		  </div>
