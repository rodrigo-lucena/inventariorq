<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="tab-pane" style="padding: 5px 5px 5px 5px">
    ...
    <form class="row g-2 fs-4" action="/adicionar/item" method="post" style="margin-top: 10px; padding: 10px 10px 10px 10px">
  	...
  	<div class="col-8" style="padding: 5px 5px 5px 5px"> 
  		<legend class="mt-5"> Excluir/Atualizar Marca</legend>
	  	...
	  	<table class="table table-striped fs-4">			  
		  	<tbody>
	          	...
	          	<form class="row g-2 fs-4" action="/adicionar/<?php echo htmlspecialchars( $item, ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $value1["idmarca"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" method="post" style="padding: 10px 10px 10px 10px">
	          		<tr  style="text-align: left">
	            		...
	            		<td >
		            		<div class="row">
		              			<input class="col form-control fs-4" type="text" name="marca" value="<?php echo htmlspecialchars( $value1["marca"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" required>
