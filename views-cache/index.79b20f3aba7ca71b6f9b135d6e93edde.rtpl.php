<?php if(!class_exists('Rain\Tpl')){exit;}?>				<div class="content-wrapper" style="padding: 5px 2px 5px 5px">
					  	...
					  	<div class="col-md-12">
					  		<div class="box box-primary">
					            ...
					            <form>
								  ...
								  <div class="mb-3 row fs-4" style="padding: 3px 3px 3px 3px">
								  	<div class="col-1"><label for="form-check-input" class="form-label">Base:</label></div>
								  	<div class="col-2">
									  	
									  	<div class="form-check col-6 no-padding">
										    <input class="form-check-input" type="radio" name="radioB" id="CheckLacite" value="Lacite" checked>
										    <label class="form-check-label" for="CheckLacite">Lacite</label>
										</div>
